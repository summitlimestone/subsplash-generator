...
`watch` never exits on its own now: it keeps tracking the service (and
answering Trim/Stitch clicks) until you click Stop or press Ctrl+C, the
normal way every Watch session ends.
