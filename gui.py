...
class App(tk.Tk):
    ...
    def _build_offline_tab(self):
        ...
        self._labeled_entry(frame, 4, "Output path", "st_output", colspan=3, help_text=TIMESTAMP_HELP)
        self._add_browse(frame, 4, "st_output", save=True, filetypes=VIDEO_FILETYPES, col=3)
        self.vars["st_output"].set("output.mp4")

        self._labeled_entry(frame, 5, "Sermon start", "st_start", width=13, col=0)
        self.vars["st_start"].set("00:00:00.000")
        self._labeled_entry(frame, 5, "Sermon end", "st_end", width=13, col=2, pad_left=16)
        ...
        trim_visually_btn.grid(row=5, column=4, sticky="w", padx=(16, 0))
        Tooltip(
            trim_visually_btn,
        ...
        self._labeled_combobox(
            frame, 6, "Transition type", "st_transition", XFADE_TRANSITIONS, width=12, col=0,
        )
        self.vars["st_transition"].set("fade")
        self._labeled_entry(frame, 6, "Transition duration (s)", "st_duration", width=8, col=2, pad_left=16)
